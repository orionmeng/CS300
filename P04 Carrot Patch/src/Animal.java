...
//
// Title: P04 Carrot Patch Animal Class
...
public class Animal implements GUIListener {
  ...
  public void mousePressed() {
    ...
    System.out.println("animal mouse pressed called");
    if (this.isMouseOver()) {
      isDragging = true;
    }
  }
  ...
  public void mouseReleased() {
    // TODO Auto-generated method stub
    System.out.println("animal mouse released called");
    isDragging = false;
  }
  ...
  public boolean isMouseOver() {
    if (processing.mouseX >= x - this.image.width / 2
  ...
  public boolean isClose(Animal otherAnimal, int range) {
    ...
    boolean close = false;
    close = isClose(otherX, otherY, range);
    return close;
